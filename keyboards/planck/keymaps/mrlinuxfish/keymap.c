/* Copyright 2015-2020 Dustin Bosveld
 *
...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_LSFT, KC_ENT),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,    _______, _______, _______, KC_INS,  KC_PSCR, KC_PAUS, KC_UNDS,  KC_PLUS,    KC_LCBR,    KC_RCBR,    KC_PIPE,
    S(KC_ENT),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,    KC_F8,      KC_F9,      KC_F10,     _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_EJCT, KC_APP,  _______, _______, KC_DEL,  KC_SLCK,  KC_NLCK, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS,
    KC_CAPS, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,   KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  _______,
    KC_RCTL, _______, _______, _______, _______, _______,  _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
...
void keyboard_pre_init_user(void) {
    setPinOutput(D3);  // initialize Layer 0 led
    setPinOutput(D2);  // initialize Layer 1 led
    setPinOutput(D1);  // initialize Layer 2 led
    setPinOutput(B3);  // initialize Layer 3 led
}
...
layer_state_t layer_state_set_user(layer_state_t state) {
    switch (get_highest_layer(state)) {
        ...
        case _LOWER:  //Layer 1
            ...
            writePinLow(B3);
            break;
        case _COLEMAK:  //Layer 2
            writePinHigh(D1);
            writePinLow(D3);
            writePinLow(D2);
            writePinLow(B3);
        case _PLOVER:  //Layer 3
            writePinHigh(B3);
            writePinLow(D3);
            writePinLow(D2);
            writePinLow(D1);
